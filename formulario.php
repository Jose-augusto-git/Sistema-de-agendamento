...
uf,endereco,qp,qs,hma,exames,cirurgias,menarca,tireoide,estomago,pancreas,coracao,utero,prostata,menopausa,rins,intestino,figado,sintoma,osteopatia,dhs,microfisioterapia,homeopatia,pulmao,sono) VALUES ('$nome','$telefone','$nascimento','$dataHoje','$email','$profissao','$cidade',
'$uf','$endereco','$qp','$qs','$hma','$exames','$cirurgias','$menarca','$tireoide','$estomago','$pancreas','$coracao','$utero','$prostata','$menopausa','$rins','$intestino','$figado','$sintoma','$osteopatia','$dhs','$microfisioterapia','$homeopatia','$pulmao','$sono')";
