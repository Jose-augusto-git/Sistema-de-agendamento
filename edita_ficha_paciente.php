...
$result_usuario = "UPDATE ficha SET  nome='$nome',telefone='$telefone',nascimento='$nascimento',dataHoje='$dataHoje',email='$email',profissao='$profissao',cidade='$cidade',uf='$uf',endereco='$endereco',qp='$qp',qs='$qs',hma='$hma',exames='$exames',cirurgias='$cirurgias',menarca='$menarca',tireoide='$tireoide',estomago='$estomago',pancreas='$pancreas',coracao='$coracao',utero='$utero',prostata='$prostata',menopausa='$menopausa',rins='$rins',intestino='$intestino',figado='$figado',sintoma='$sintoma',osteopatia='$osteopatia',dhs='$dhs',microfisioterapia='$microfisioterapia',homeopatia='$homeopatia',pulmao='$pulmao',sono='$sono' WHERE id='$id'";
