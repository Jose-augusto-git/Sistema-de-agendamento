                    ...
                    <fieldset>
                       ...
                       <div class="select-block">   
                        ...
                        <div class="input-block">
                            ...
                            <input name="hma" id="hma" value="<?php 
                            echo $row_usuario['hma'];
                        ...
                        <div class="input-block">
                            ...
                            <input name="osteopatia" id="osteopatia" value="<?php 
                            echo $row_usuario['osteopatia'];
                            
                            ?>">
                        </div>
                        <div class="input-block">
                            <label for="dhs"> DHS </label> <!--Address e endereço em ingles-->
                            <input name="dhs" id="dhs" value="<?php 
                            echo $row_usuario['dhs'];
                            
                            ?>">
                        </div>
                        <div class="input-block">
                            <label for="microfisioterapia"> MICROFISIOTERAPIA </label> <!--Address e endereço em ingles-->
                            <input name="microfisioterapia" id="microfisioterapia" value="<?php 
                        ...
                        <div class="input-block">
                            ...
                            <input name="homeopatia" id="homeopatia" value="<?php 
