...
<body id="busca" style='font-size: 2rem;'>
    ...
    <div id="container" style="background:white">
        <header class="page-header" style="background-color: black;box-shadow: 5px 5px rgba(0, 0, 0, .6);">
            <div class="top-bar-container">
            <a href="index.php">
                        <?php
                            echo "<img src='imagem/seta.svg' alt='voltar'>";
                        ?>                     
            </a>
            ...
            <div class="header-content">
                <div id="imagem">
                        <?php
                            echo "<img src='imagem/lista-medicamento.svg' alt='lista'>";
                        ?>         
                    
                </div>
                <strong>Busca de medicamentos disponiveis </strong><!--strong vem com a fonte em negrito-->
                <p style='color:red; font-size:2.5rem'>Pesquise no campo abaixo os sintomas</p>
                <?php
                ...
                <form id="busca-cliente" method="POST" action="">
                    <div class="select-block">
                        <label> Pesquisar Sintomas </label>
                            <div class="select-block">
                        
                        
                            
                             <input id="subject" type="text" name="principal" placeholder="Digite o sintoma">
                        ...
                        <div>
                            ...
                            if($SendPesqUser){
                                ...
                                while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
                                    ...
                                    font: 700 2rem Archivo;
                                    cursor: pointer;'
                                    href='proc_apagar_usuario.php?id=" . $row_usuario['id'] . "' 
